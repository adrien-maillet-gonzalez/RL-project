...
#SBATCH --output=PPO_MountainCar-v0_seed-2_%j.out
#SBATCH --error=PPO_MountainCar-v0_seed-2_%j.err
...
# Run your code
python -m baselines.run --alg=ppo2 --env=MountainCar-v0 --network=mlp --num_timesteps=1e6 --seed=2
