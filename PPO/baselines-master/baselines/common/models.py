...
def nature_cnn(unscaled_images, **conv_kwargs):
    ...
    activ = tf.nn.relu
    h = activ(conv(scaled_images, 'c1', nf=64, rf=8, stride=4, init_scale=np.sqrt(2),
                   **conv_kwargs))
...
@register("mlp")
def mlp(num_layers=2, num_hidden=32, activation=tf.tanh, layer_norm=False): #used num_hidden=32 for montain car & continuous and cartpolejust
    """
