...
#SBATCH --output=PPO_CartPole-v1_seed-0_%j.out
#SBATCH --error=PPO_CartPole-v1_seed-0_%j.err
...
# Run your code
python -m baselines.run --alg=ppo2 --env=CartPole-v1 --network=mlp --num_timesteps=1e6 --seed=0
