...
# Basic PPO implementation without clipping or penalty
# This serves as a baseline implementation
...
class PPO_Base(object):
    def __init__(
        ...
        """
        Initialize PPO with standard surrogate objective (no clipping or penalty)
    ...
    def train(self, buffer):
        ...
        for epoch in range(self.epochs):
            ...
            for start in range(0, states.shape[0], self.mini_batch_size):
                ...
                # Compute surrogate policy loss - E_t[r_t(θ) * A_t]
                # This is the standard surrogate objective without clipping
                policy_loss = -(ratio * advantage_batch).mean()
